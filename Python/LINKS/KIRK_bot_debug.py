# Links - KIRK Bot - Debug Console Logger
#
# By: traBpUkciP
...
def userInput():
    ...
    f = open("F:\JARVIS\Chatbot\ALICE\dictation.txt")
    print "success"
...
def clearInput():
    ...
    f = open('F:\JARVIS\Chatbot\ALICE\dictation.txt', 'w')
    print "opened file"
    f.write("False")
...
def writeHistory(i):
    ...
    f = open('F:\JARVIS\Chatbot\ALICE\history.txt', 'a')
    print "success"
